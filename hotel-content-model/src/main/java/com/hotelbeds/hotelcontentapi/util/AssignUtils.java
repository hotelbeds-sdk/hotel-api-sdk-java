...
import com.hotelbeds.hotelcontentapi.auto.common.SimpleTypes;
...
public final class AssignUtils {
    ...
    public static Boolean safeBoolean(final String stringSY) {
        ...
        if (StringUtils.isNotEmpty(stringSY)
            && (SimpleTypes.SiNo.S.name().equalsIgnoreCase(stringSY) || SimpleTypes.YesNo.Y.name().equalsIgnoreCase(stringSY))) {
            result = Boolean.TRUE;
        }
        return result;
    }
